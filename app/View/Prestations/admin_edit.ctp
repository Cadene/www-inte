...
<?php echo $this->Form->create('Prestation'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Prestation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Prestation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Prestation.id'))); ?></li>
