<div class="participations index">
	...
	<tr>
		...
		<td><?php echo h($participation['Participation']['date']); ?>&nbsp;</td>
		<td><?php echo h($participation['Participation']['montant']); ?>&nbsp;</td>
		<td><?php echo h($participation['Participation']['type']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $participation['Participation']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $participation['Participation']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
